...
namespace EMS
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\SPECTRE\Documents\employee.mdf;Integrated Security=True;Connect Timeout=30");
        public AddEmployee()
        {
            InitializeComponent();
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkEm = new SqlCommand(checkEmID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\SPECTRE\source\repos\EMS\EMS\Directory\"
        ...
        private void addEmployeeguna2Button1_Click(object sender, EventArgs e)
        {
        ...
        private void guna2Button2Update_Click(object sender, EventArgs e)
        {
        ...
        private void guna2Button3Delete_Click(object sender, EventArgs e)
        {
            if (addEmployee_id.Text == ""
               || addEmployee_fullName.Text == ""
               || addEmployee_gender.Text == ""
        ...
        private void guna2Button3Clear_Click(object sender, EventArgs e)
        {
            clearFields();
        }

        private void guna2Button3Import_Click(object sender, EventArgs e)
        {
            try
            {
                OpenFileDialog dialog = new OpenFileDialog();
